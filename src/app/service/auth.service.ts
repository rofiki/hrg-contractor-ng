...
export class AuthService {
  ...
  regis1(){
    let password:any = this.MD5('asdfghjkl');
    let post:any = {
   //   "users_id": 4,
      "firstname": 'Rofiki',
      "lastname": 'Harong',
      ...
      "role": "admin",
     // "salt": "kjT0eWczgo",
     // "token": "90bfb14beef1ca236ddd7125e3a4b216",
     // "created_at": "2023-09-06T00:41:07.000000Z",
     // "updated_at": "2023-09-06T00:41:07.000000Z"
  ...
  MD5 (e: any) {
    ...
    function k(a: any, b: any, c: any, d: any, e: any, f: any, g: any) {
      a = h(a, h(h((b & c) | (~b & d), e), g));
      return h((a << f) | (a >>> (32 - f)), b);
    }

    function l(a: any, b: any, c: any, d: any, e: any, f: any, g: any) {
      a = h(a, h(h((b & d) | (c & ~d), e), g));
      return h((a << f) | (a >>> (32 - f)), b);
    }

    function m(a: any, b: any, d: any, c: any, e: any, f: any, g: any) {
      a = h(a, h(h(b ^ d ^ c, e), g));
      return h((a << f) | (a >>> (32 - f)), b);
    }

    function n(a: any, b: any, d: any, c: any, e: any, f: any, g: any) {
      a = h(a, h(h(d ^ (b | ~c), e), g));
      return h((a << f) | (a >>> (32 - f)), b);
    }
